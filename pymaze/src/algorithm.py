...
def depth_first_recursive_backtracker(maze, start_coor, debug=False):
    ...
    if debug: print("Number of moves performed: {}".format(len(path)))
    if debug: print("Execution time for algorithm: {:.4f}".format(time.time() - time_start))
