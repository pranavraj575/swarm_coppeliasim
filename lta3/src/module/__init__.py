...
To edit this documentation, navigate to the docs folder of lta3 and then run

.. code-block:: bash

    make html

The documentation will be built in the build/html/index.html.  The following is a cheat sheet of everything that is possible when addition additional documentation:
