...
class Waypoints:
    ...
    def __init__(self):
        self.waypoint_publisher = rospy.Publisher("ref_wp", state_18DOF, queue_size=10)
        ...
        while True:
            ...
            try:
                ...
                if len(coords) == 3:
                    ...
                    v.pose.pose.position.x  = coords[0]
                    v.pose.pose.position.y  = coords[1]
                    v.pose.pose.position.z  = coords[2]
