...
class Waypoints:
    ...
    def __init__(self):
        ...
        self.data_subscriber = rospy.Subscriber("data", floats, self.data_update, queue_size=10)
        self.data = floats()
    ...
    def talker(self):
        ...
        while not rospy.is_shutdown():
            if not self.wp:
                v_goal = Vector3f.Vector3(0, 0, height)
            else:
            ...
            print self.lta3_id + "    " + str(self.data)
        ...
        #             p_full = Vector3.Vector3(coords[0] + v_full.x,
        #                 coords[1] + v_full.y,
        #                 coords[2] + v_full.z)
